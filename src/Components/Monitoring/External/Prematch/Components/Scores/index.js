function Monitoring_Prematch_Scores ($stateParams, eventsResource, $rootScope) {
	var _this     = this;
...
module.exports = {
	template    : require('./monitoring.prematch.scores.html'),
	controller  : Monitoring_Prematch_Scores,
	controllerAs: 'vm'
};