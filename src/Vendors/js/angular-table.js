...
(function () {
	...
	ColumnConfiguration = (function () {
		...
		ColumnConfiguration.prototype.renderSorting = function (element) {
			...
			if (this.sortable) {
				...
				icon = angular.element("<i class='pull-right material-icons'></i>");
				icon.attr("ng-bind", "getSortIcon('" + this.attribute + "', predicate, descending)");
	...
	paginationTemplate =
		...
		"<div>" +
			"<button class='mdl-button' ng-disabled='getCurrentPage() <= 0' ng-click='stepPage(-numberOfPages)'>" +
			"<i class='material-icons'>first_page</i>" +
			"</button>" +
		"</div>" +
		"<div>" +
			"<button class='mdl-button' ng-disabled='getCurrentPage() <= 0' ng-click='jumpBack()'>" +
			"<i class='material-icons'>arrow_back</i>" +
			"</button>" +
		"</div>" +
		"<div>" +
			"<button class='mdl-button' ng-disabled='getCurrentPage() <= 0' ng-click='stepPage(-1)'>" +
			"<i class='material-icons'>chevron_left</i>" +
			"</button>" +
		"</div>" +
		"<div ng-class='{active: getCurrentPage() == page}' ng-repeat='page in pageSequence.data'>" +
			"<button class='mdl-button' ng-click='goToPage(page)' ng-bind='page + 1'></button>" +
		"</div>" +
		"<div>" +
			"<button class='mdl-button' ng-disabled='getCurrentPage() >= numberOfPages - 1' ng-click='stepPage(1)'>" +
			"<i class='material-icons'>chevron_right</i>" +
			"</button>" +
		"</div>" +
		"<div>" +
			"<button class='mdl-button' ng-disabled='getCurrentPage() >= numberOfPages - 1' ng-click='jumpAhead()'>" +
			"<i class='material-icons'>arrow_forward</i>" +
			"</button>" +
		"</div>" +
		"<div>" +
			"<button class='mdl-button' ng-disabled='getCurrentPage() >= numberOfPages - 1' ng-click='stepPage(numberOfPages)'>" +
